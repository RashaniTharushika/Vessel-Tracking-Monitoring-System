            ...
            <div className="col-6">
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="MBL" name="MBL" placeholder="Master Bill of Lading Number" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="VESSEL" name="VESSEL" placeholder="Vessel Name" type="text" class="form-control"
                                   required="required"></input>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select id="Carrier" name="Carrier" required="required" class="custom-select"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="pol" name="pol" placeholder="Loading Port" type="text" class="form-control"
                                   required="required"></input>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="etd" name="etd" placeholder="ETD " type="text" class="form-control"
                                   required="required"></input>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="etaToCMB" name="etaToCMB" placeholder="ETA to CMB" type="text"
                                   class="form-control" required="required"></input>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select id="NeedRegistering" name="NeedRegistering" class="custom-select"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="TrackingCommonMBL " name="TrackingCommonMBL " placeholder="Tracking Common MBL "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="MMSI" name="MMSI" placeholder="MMSI" type="text" class="form-control"
                                   required="required"></input>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="Voyage" name="Voyage" placeholder="Voyage No" type="text" class="form-control"
                                   required="required"></input>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="HBL" name="HBL" placeholder="HBL" type="text" class="form-control"
                                   required="required"></input>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="ShipmentType" name="ShipmentType" placeholder="Shipment Type" type="text"
                                   class="form-control" required="required"></input>
                        </div>
                    </div>
